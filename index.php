...
<?php include 'menu.php';?>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="banner7.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="titlepage">
                     <h2>NEW ARRIVALS STARTING AT RS.1000</h2>
                     <p>Buy 1 Get 1 Free with 2 Years Gold Membership at R̶s̶.̶1̶2̶0̶0̶ Rs.600</p>
                  </div>
               </div>
            </div>
         </div>
         <div class="container-fluid">
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div class="card">
                  <figure><img src="img/g6.jpg" alt="#"/></figure>
               </div>
            </div>

               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                   <div class="card">
                  <figure><img src="img/g3.png" alt="#"/></figure>
               </div>
            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div class="card">
                  <figure><img src="img/p5.png" alt="#"/></figure>
               </div>
            </div>

               
               <div class="col-md-12">
                  <a class="read_more" href="register.php">Shop More</a>
               </div>
            </div>
         </div>
      </div>
